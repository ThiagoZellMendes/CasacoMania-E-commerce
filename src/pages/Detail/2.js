  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <View>
          <Text style={[styles.title,{ fontSize: 24}]}>R$ 300,90</Text>
        </View>
        <View opacity={0.4}>
          <Text style={[styles.title,{ fontSize: 30}]}>Moletom Suffix Masculino</Text>
        </View>
        ...
        <TouchableOpacity style={styles.btnContainer} onPress={() => teste()}>
            <Text style={styles.titleB}>ADICIONAR AO CARRINHOO</Text>
        </TouchableOpacity>
        </View>
