  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <View>
          <Text style={[styles.title,{ fontSize: 24}]}>$450,99</Text>
        </View>
        <View opacity={0.4}>
          <Text style={[styles.title,{ fontSize: 30}]}>Moletons Liso Flanelado</Text>
        </View>
