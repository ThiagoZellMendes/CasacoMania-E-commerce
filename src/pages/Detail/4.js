...
export default function Detail4({navigation}) {
  ...
  useEffect(() => { 
    navigation.setOptions({
      headerTitle: 'Moletom Fechado Trivalle',
    }) 
})
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <View>
          <Text style={[styles.title,{ fontSize: 24}]}>R$ 250,00</Text>
        </View>
        <View opacity={0.4}>
          <Text style={[styles.title,{ fontSize: 30}]}>Moletom Fechado Trivalle</Text>
        </View>
